...
<html lang="en">
  ...
  <body>
    ...
    <div class="center-message">
      ...
      <!--Sửa tiêu đề chúc mừng ở đây-->
      <span id="centerText">
        Ngày Phụ nữ Việt Nam<br />
        <!-- Sử lời nhắn hiển thị đầu ở đây-->
    ...
    <script>
      ...
      const messages = [
        {
          img: "./assets/b1.jpg", //Thay ảnh
          text: "Chúc bé luôn vui vẻ, xinh đẹp và ngập tràn yêu thương!", //Thay lời nhắn
        },
        {
          img: "./assets/b2.jpg",
          text: "Chúc bé yêu của anh mỗi ngày đều đáng yêu như hiện tại. Anh thương bé!",
        },
        {
          img: "./assets/b3.jpg",
          text: "Cảm ơn em vì đã vì đã đến bên anh!",
        },
        {
          img: "./assets/b4.jpg",
          text: "Chúc bé yêu  một ngày 20/10 thật hạnh phúc và trọn vẹn! ",
        },
        {
          img: "./assets/b5.jpg",
          text: "Có em là món quà tuyệt vời nhất anh từng có. Chúc em luôn vui, anh luôn ở đây bên em.! ",
        },
      ];
